...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        "Привет! 👋 Я HSE Compass — помощник для абитуриентов московской Вышки "
    "(бакалавриат, 2026) 🎓\n\n"
    "Подскажу про сроки, программы, баллы, олимпиады, скидки и стоимость обучения 🧭\n"
    "Задай вопрос — помогу, чем смогу. Я не приемная комиссия, но тоже стараюсь 🤪💙"
    )
