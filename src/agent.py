...
ROUTER_PROMPT = (
    ...
    "- OUT_OF_SCOPE - если вопрос не относится к поступлению в ВШЭ "
    "(погода, развлечения, личные вопросы, общежитие и т.д.)\n"
    "- NEEDS_REWRITE - если вопрос содержит сокращения, опечатки, "
    "разговорный стиль или неформальные выражения\n"
    "- DIRECT - если вопрос сформулирован четко и формально, "
    "можно искать напрямую\n"
    "Контекст: бот отвечает на вопросы о поступлении в НИУ ВШЭ, "
    "Москва, бакалавриат, 2026 год."
)
